...
public class mMainMenuController {
    ...
    // Campos FXML (Componentes de la UI)

    @FXML private BorderPane bp;
    @FXML private TabPane tabPaneFx;
    @FXML private Circle circleUsuario;
    @FXML private Node iconBars, iconHome, iconAnalytics, iconGallery, iconSettings, iconAdd;
    ...
    public void onIconAnalyticsClicked(MouseEvent e) {
        abrirPaginaEnContenido("/view/main_producto.fxml");
    }
    ...
    public void simularLogin(String perfil) {
        ...
        graficarMenus();
        onIconHomeClicked(null);

        showNotification("Sesión simulada como: " + perfil, 3000);
    }


    // Métodos de Configuración y Helpers
        ...
        navigationService.registerNavigateCallback((view, data) -> {
            Platform.runLater(() -> {
                ...
                switch (String.valueOf(view)) {
                    ...
                    case "analytics": abrirPaginaEnContenido("/view/mMainMenu/MainMenu/mMainMenu.fxml"); break;
                    case "gallery": abrirPaginaEnContenido("/view/page_gallery.fxml"); break;
                    case "settings": abrirPaginaEnContenido("/view/page_settings.fxml"); break;
    ...
    private void graficarMenus() {
        ...
        if (bp != null) bp.setTop(null); // Asegura que no haya MenuBar
    }
