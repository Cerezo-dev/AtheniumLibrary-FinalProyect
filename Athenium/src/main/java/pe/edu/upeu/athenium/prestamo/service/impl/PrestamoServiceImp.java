package pe.edu.upeu.athenium.prestamo.service.impl;
...
import pe.edu.upeu.athenium.prestamo.repository.PrestamoRepository;
import pe.edu.upeu.athenium.prestamo.service.IPrestamoService;
...
public class PrestamoServiceImp extends CrudGenericoServiceImp<Prestamo, Long> implements IPrestamoService {
    ...
    public JasperPrint runReport(Long idv) throws JRException, SQLException
    {
        ...
        if (!prestamoRepository.existsById(idv)) {
